  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
    ...
    <div className="space-y-12">
      ...
      <div className="space-y-8 pt-6">
        ...
        <p className="text-foreground font-medium text-lg pt-6 border-t-2 border-accent/30">
    ...
    <div className="flex justify-center">
      ...
      <div className="relative w-[380px] md:w-[420px] h-[520px] md:h-[600px] rounded-lg overflow-hidden">
